...
![Pop-up box with menu for names that need correction and suggested ward names for the correction.](images/Screenshot 2025-02-20 143121.png)
...
![Dropdown menu with the choice of smoothing approaches.](images/smoothing.png)
...
![Option two - the vulnerability map based on the median ranks of each ward.](images/vulnerability_map (2).png)
